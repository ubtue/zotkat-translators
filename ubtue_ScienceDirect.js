{
	"translatorID": "17a637f9-5c2c-4a68-bc1a-a9e31fe2fb16",
	"label": "ubtue_ScienceDirect",
	...
	"lastUpdated": "2023-11-22 10:57:15"
}
...
function processRIS(doc, text) {
	...
	translator.setHandler("itemDone", function (obj, item) {
		...
		if (item.ISSN == "1756-0616" && item.pages.match(/\d{4}/)) {
...
var testCases = [
	...
	{
		"type": "web",
		"url": "https://www.sciencedirect.com/science/article/abs/pii/S1756061623000290",
		"items": [
			{
				"itemType": "journalArticle",
				"title": "Reporting the real names of juvenile offenders: A study of Japanese perspectives through the lens of symbolic discrimination",
				"creators": [
					{
						"lastName": "Watamura",
						"firstName": "Eiichiro",
				...
				"tags": [
					...
					{
						"tag": "Real-name reportage"
					},
					{
						"tag": "Symbolic discrimination"
					}
				],
				"notes": [
					"artikelID:100603"
