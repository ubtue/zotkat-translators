{
	...
	"translatorType": 2,
	"browserSupport": "gcs",
	"lastUpdated": "2020-08-20 13:04:00"
}
...
function addLine(itemid, code, value) {
    ...
    var line = code + " " + value.trim().replace(/"/g, '\\"').replace(/“/g, '\\"').replace(/”/g, '\\"').replace(/„/g, '\\"').replace('|s|RezensionstagPica', '').replace(/\t/g, '').replace(/\t/g, '');
