{
	...
	"lastUpdated": "2026-09-01 13:36:08"
}
...
function invokeEMTranslator(doc) {
	...
	translator.setHandler("itemDone", function (t, i) {
		...
		if (orcidAuthorEntryCaseI.length && ['2182-8822', '2175-5841','1983-2478'].includes(i.ISSN)) {
		...
		//artikelID und Seitenzahlen im Format "1-20, e292601"
		if (["2447-7443"].includes(i.ISSN)) {
			let pageCitation = ZU.xpathText(doc, '//meta[@name="DC.Identifier.pageNumber"]/@content');
			if (pageCitation) {
				delete i.pages;
				let articleID = pageCitation.match(/e\d+/);
				if (articleID) {
					i.notes.push('artikelID:' + articleID);
				}
				let pageNumbers = pageCitation.match(/^(\d+(?:-\d+)?),/);
				if (pageNumbers) {
					i.pages = pageNumbers[1];
				}
			}
		}
		...
		if (['2175-5841', '1853-9106', '2254-6227', '1860-8213', '2500-5413', '0717-6295', '1980-6736', '1126-8557', '3052-4989', '2974-7309','1983-2478','2176-1078'].includes(i.ISSN)) {
		...
		if (['2617-3697', '2660-4418', '2748-6419', '1988-3269', '1804-6444', '2391-4327', '2174-0887', '2709-8435', '2296-469X', '2057-5831', '2695-4397', '2169-2289', '2179-0019', '2254-6227', '2175-5841','1983-2478'].includes(i.ISSN)) {
		...
		if (['1853-9106', '2254-6227', '1860-8213', '2500-5413', '1980-6736', '2237-6461', '3052-4989', '2660-955X', '2660-955X', '2447-7443', '2974-7309','1983-2478', '2176-1078'].includes(i.ISSN)) {
