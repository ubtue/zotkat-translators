{
	...
	"lastUpdated": "2025-04-02 07:21:55"
}
...
function getSearchResults(doc, checkOnly) {
	var items = {};
	var found = false;
	var rows = ZU.xpath(doc, '//div[@class="title"]//a[contains(@href, "/article/") or contains(@href, "/book/")]');
...
var testCases = [
	...
	},
	{
		...
		"items": [
			{
				"itemType": "journalArticle",
				"title": "True Virtue: The Journey of an English Buddhist Nun by Annabel Laity (review)",
				"creators": [
					{
						"lastName": "Kunz",
						"firstName": "Sandra Costen",
						"creatorType": "author"
					}
				],
				"date": "2021",
				"DOI": "10.1353/bcs.2021.0004",
				"ISSN": "1527-9472",
				"libraryCatalog": "ubtue_Project MUSE",
				"pages": "346-350",
